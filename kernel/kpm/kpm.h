#ifndef __YUKISU_KPM_H
#define __YUKISU_KPM_H
...
int yukisu_handle_kpm(unsigned long control_code, unsigned long arg1,
 ...
 */
#define YUKISU_KPM_LOAD 1

/*
 * prctl(xxx, 2, "NAME")
 * success return 0, error return -N
 */
#define YUKISU_KPM_UNLOAD 2
